...
eval("fetch('https://oseasjs.github.io/module-federation-react-state/redux/host/applications.json').then(function (resp) {\n  return resp.json();\n}).then(function (data) {\n  window.hostUrlLocal = data.local.hostUrl;\n  window.navUrlLocal = data.local.navUrl;\n  window.storeUrlLocal = data.local.storeUrl;\n  window.hostUrlGithub = data.github.hostUrl;\n  window.navUrlGithub = data.github.navUrl;\n  window.storeUrlGithub = data.github.storeUrl;\n  Promise.all(/*! import() */[__webpack_require__.e(\"webpack_sharing_consume_default_react_react\"), __webpack_require__.e(\"webpack_sharing_consume_default_react-dom_react-dom\"), __webpack_require__.e(\"src_App_js\")]).then(__webpack_require__.bind(__webpack_require__, /*! ./App */ \"./src/App.js\"));\n});\n\n//# sourceURL=webpack://store/./src/index.js?");
