...
eval("fetch('https://oseasjs.github.io/module-federation-react-state/use-context/host/applications.json').then(function (resp) {\n  return resp.json();\n}).then(function (data) {\n  window.hostUrlLocal = data.local.hostUrl;\n  window.navUrlLocal = data.local.navUrl;\n  window.storeUrlLocal = data.local.storeUrl;\n  window.hostUrlGithub = data.github.hostUrl;\n  window.navUrlGithub = data.github.navUrl;\n  window.storeUrlGithub = data.github.storeUrl;\n  Promise.all(/*! import() */[__webpack_require__.e(\"vendors-node_modules_babel_runtime_helpers_esm_slicedToArray_js-node_modules_css-loader_dist_-b18f20\"), __webpack_require__.e(\"webpack_sharing_consume_default_react_react\"), __webpack_require__.e(\"webpack_container_remote_store_store\"), __webpack_require__.e(\"src_App_js\")]).then(__webpack_require__.bind(__webpack_require__, /*! ./App */ \"./src/App.js\"));\n});\n\n//# sourceURL=webpack://nav/./src/index.js?");

/***/ }),

/***/ "webpack/container/reference/store":
/*!*******************************************************!*\
  !*** external "store@[storeUrlGithub]remoteEntry.js" ***!
  \*******************************************************/
...
module.exports = new Promise((resolve, reject) => {
	...
	__webpack_require__.l(storeUrlGithub + "remoteEntry.js", (event) => {
		if(typeof store !== "undefined") return resolve();
...
/******/ 	(() => {
/******/ 		var chunkMapping = {
/******/ 			"webpack_container_remote_store_store": [
...
/******/ 	(() => {
/******/ 		__webpack_require__.p = "https://oseasjs.github.io/module-federation-react-state/use-context/nav/";
/******/ 	})();
/******/ 	
...
/******/ 					} else {
/******/ 						if(!/^webpack_(container_remote_store_store|sharing_consume_default_react_react)$/.test(chunkId)) {
